...
<%
    ...
    String filePath = "C:\\xampp\\htdocs\\picture\\";// context.getInitParameter("file-upload");
            ...
            while (i.hasNext()) {
                ...
                if (!fi.isFormField()) {
                    ...
                    if (fileName.lastIndexOf("\\") >= 0) {
                        picture = fileName.substring(fileName.lastIndexOf("\\"));
                        file = new File(filePath
                                + fileName.substring(fileName.lastIndexOf("\\")));
                    } else {
                        picture = fileName.substring(fileName.lastIndexOf("\\") + 1);
